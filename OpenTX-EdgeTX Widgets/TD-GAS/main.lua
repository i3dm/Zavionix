...
local function drawTurbine(Me,x,y)
	...
	--	lcd.drawText(x,y-10,status_str,DBLSIZE)
	--else
	--	lcd.drawText(x,y-10,status_str,INVERS + DBLSIZE)
	--end
	lcd.drawText(x,y+33,"RPM:")
	lcd.drawText(x+52,y+26,format_thousand(getValue("RPM")*1),MIDSIZE)
	lcd.drawText(x,y+58,"Temp 1:")
	lcd.drawText(x+68,y+51,getValue("Tmp1").."c",MIDSIZE)
	lcd.drawText(x,y+83,"Temp 2:")
	lcd.drawText(x+68,y+76,getValue("Tmp2").."c",MIDSIZE)
	--lcd.drawText(x,y+108,"ECU:")
	--lcd.drawText(x+52,y+101,round(getValue("A3"),2).."v",MIDSIZE)
end
...
local function refreshWidget(Me)
	...
	lcd.drawText(363,15,round(getValue(getTelemetryId('RxBt')),1).."v",MIDSIZE)
	--Tx Battery voltage
	lcd.drawText(422,3,"TxBatt",SMLSIZE+BLACK)
	lcd.drawText(422,15,round(getValue('tx-voltage'),1).."v",MIDSIZE)
	--Fuel
	--lcd.drawText(15,195,"FUEL:", SMLSIZE )
	--lcd.drawText(15,208,round(Me.param.tank_rem, 0).."ml",MIDSIZE )	
	--Throttle
	lcd.drawText(100,195,"Fuel:", SMLSIZE )
	lcd.drawText(100,208, round(getValue("Fuel"),1).."ml",MIDSIZE )
	--lcd.drawText(30,195,"Current:", SMLSIZE )
	--lcd.drawText(30,208, round(getValue("Curr"),1).."A",MIDSIZE )
	lcd.drawText(210,195,"Throttle:", SMLSIZE )
	lcd.drawText(210,208, round((getValue("thr") + 1024)/20.48).."%",MIDSIZE )
	--lcd.drawText(210,208, round(getValue("VSpd"),1).."%",MIDSIZE )
